...
import com.yyz.service.SysFileService;
...
public class SysFileController {
    ...
    public ResultVO<?> queryAll() {
        return ResultUtil.success(sysFileService.queryAll());
    }
    ...
    public ResultVO<?> queryOne(@PathVariable Integer id) {
        return ResultUtil.success(sysFileService.queryById(id));
    }
     ...
     */
    @PostMapping("/create")
    public ResultVO<?> create(@RequestBody SysFile sysFile) {
     ...
     */
    @PutMapping
    public ResultVO<?> update(@RequestBody SysFile sysFile) {
        return sysFileService.updateById(sysFile) ? ResultUtil.success() : ResultUtil.failure();
    }
